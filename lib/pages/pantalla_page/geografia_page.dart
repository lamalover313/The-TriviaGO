...
class GeografiaPage extends StatefulWidget {
  const GeografiaPage({super.key});

  @override
  State<GeografiaPage> createState() => _GeografiaPageState();
}

class _GeografiaPageState extends State<GeografiaPage> {
  ...
  Future<void> _loadQuestions({required String difficulty}) async {
    try {
      ...
      if (difficulty == "easy") {
        apiQuestions = await geprovider.getProductsAsync();
      } else if (difficulty == "medium") {
        apiQuestions = await gmprovider.getProductsAsync();
      } else if (difficulty == "hard") {
        apiQuestions = await ghprovider.getProductsAsync();
      }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CustomAppBar(title: 'Geografia'),
